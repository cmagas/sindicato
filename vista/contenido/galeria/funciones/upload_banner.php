<?php
	...
	else 
	{
		if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) 
		{
			...
			$update="UPDATE 204_galeria SET url_imagen='".$ruta."' WHERE idGaleria='".$id_banner."'";
			$resul=$con->ejecutarConsulta($update);
...
<?php
	...
	function eliminarRegistro($id)
	{
		...
		$consulta="DELETE FROM 204_galeria WHERE idGaleria='".$id."'";
