...
class nusoap_base {
	...
	*/
	...
	{
		//echo $this->getmicrotime().' '.get_class($this).": ".$string."<br>";
...
class soap_transport_http extends nusoap_base {
	...
	* @access   private
	*/
	function connect($connection_timeout=0,$response_timeout=60000000)
	{
...
//		}
	...
	* @access   public
	*/
	function send($data, $timeout=0, $response_timeout=60000, $cookies=NULL) 
	{
	...
	* @deprecated
	*/
	function sendHTTPS($data, $timeout=0, $response_timeout=600000, $cookies) {
...
class wsdl extends nusoap_base {
     ...
     * @access public 
     */
    function wsdl($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=0,$response_timeout=60000,$curl_options=null,$use_curl=false){
		parent::nusoap_base();
	...
	*/
			...
			if (is_array($parameters)) 
			{
				...
				foreach ($parts as $name => $type) 
				{
					...
					if ($parametersArrayType == 'arraySimple') 
					{
						...
						$xml .= $this->serializeType($name, $type, $parameters[$name], $use, $enc_style);//bookmark
					} else {
	...
	function serializeType($name, $type, $value, $use='encoded', $encodingStyle=false, $unqualified=false)
	{
		...
		if (strpos($type, ':')) 
		{
			...
			if($ns == 'http://endpoint.solicitudespgjcdmx.apsi.com/')
			{
				$xml="<asunto>?</asunto>
						<carpetaInvestigacion>?</carpetaInvestigacion>
						<carpetaJudicial>?</carpetaJudicial>
						<carpetaJudicialAnterior>?</carpetaJudicialAnterior>
						<contenidoDeclaracion>?</contenidoDeclaracion>
						<documento>
						   <data>cid:650940350480</data>
						...
						<imputados>
						   ...
						   <sexo>?</sexo>
						   <vinculacionProceso>?</vinculacionProceso>
						</imputados>
	...
	*/
	function nusoap_parser($xml,$encoding='UTF-8',$method='',$decode_utf8=true)
	{
		...
		if(!empty($xml))
		{
			...
			$arrSegmentosXML=str_split($xml,2097152);
				
			$parseCorrecto=true;
			for($nSeg=0;$nSeg<sizeof($arrSegmentosXML);$nSeg++)
			{
				if(!xml_parse($this->parser,$arrSegmentosXML[$nSeg],(($nSeg+1)==sizeof($arrSegmentosXML))))
				{
...
class nusoap_client extends nusoap_base  {
	...
	var $response_timeout = 600000;		// HTTP response timeout
	...
	* @access   public
	*/
	function nusoap_client($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 600000, $portName = ''){
		parent::nusoap_base();
	...
	*/
	function call($operation,$params=array(),$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
		...
		//escribirContenidoArchivo("c:\\respuesta.txt",$return);
	...
	* @access   private
	*/
	function send($msg, $soapaction = '', $timeout=0, $response_timeout=600000000) 
	{
